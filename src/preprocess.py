...
def one_hot_encoder(res_mask,n_classes):
    #one hot encode yapıldı
    # makine öğrenme algoritmaları doğrudan kategorik veriler üzerinde çalışmamaktadır bu yüzden verilerimizi sayısal verilere dönüştürüyoruz.
